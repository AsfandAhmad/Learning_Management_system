...
CREATE TABLE IF NOT EXISTS Lesson (
    ...
    Title VARCHAR(150) NOT NULL,
    ContentType ENUM('PDF','Video','Text','Interactive','Assignment'),
    ContentURL VARCHAR(255),
    VideoURL VARCHAR(255),
    VideoDuration INT,
    Notes LONGTEXT,
    ResourceFiles JSON,
    LessonType ENUM('Video','Reading','Mixed','Interactive','Text','Assignment','Lecture','Practical','Quiz','Project') DEFAULT 'Mixed',
    PositionOrder INT,
    CreatedAt TIMESTAMP DEFAULT CURRENT_TIMESTAMP,

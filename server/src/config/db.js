...
const port = process.env.DB_PORT ? Number(process.env.DB_PORT) : 27794;
...
console.log(`   Host: ${process.env.DB_HOST || "nexlern321-nexlern321.l.aivencloud.com"}`);
console.log(`   Port: ${port}`);
console.log(`   User: ${process.env.DB_USER || "avnadmin"}`);
console.log(`   Database: ${process.env.DB_NAME || "NexLern"}`);

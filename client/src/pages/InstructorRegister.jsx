      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="border-t pt-4 mt-4">
          ...
          <div className="relative">
            ...
            />
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary hover:bg-primary-light transition">
        ...
        <div className="flex items-start gap-2 pt-2">
          <input type="checkbox" required className="w-4 h-4 mt-1 text-primary rounded border-gray-300 focus:ring-primary" />
        ...
        <div className="text-center text-sm text-gray-600">
          ...
          <Link to="/instructor/login" className="text-primary hover:text-primary-dark font-semibold">
            Sign In
          </Link>
        </div>
      </form>
